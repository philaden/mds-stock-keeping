...
func (m *MockIProductService) CreateSingleStock(arg0 params.UploadProductParam) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockIProductService) GetProductBySku(arg0 string) (*domain.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockIProductService) GetProducts() ([]domain.Product, error) {
	m.ctrl.T.Helper()
